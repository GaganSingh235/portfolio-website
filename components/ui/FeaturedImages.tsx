...
export const FeaturedImages = ({
    ...
    images: {name: string, designation: string, image:string}[];
    imageSize?: number;
}) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex flex-wrap justify-center sm:flex-nowrap mb-4 sm:mb-0">
                    {images.map((image, idx) => (
                        <div
                            className="-mr-4 relative group w-14 sm:w-auto"
                            key={image.name}
                            ...
                            <div className="animation-container">
                                ...
                                >
                                    <Image
                                        ...
                                        src={image.image}
                                        alt={image.name}
                                        className={`object-cover object-top h-14 w-14 md:h-${imageSize} md:w-${imageSize} `}
                                    />
                                </motion.div>
                            </div>
                        </div>
